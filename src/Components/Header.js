...
function Header() {
  return (
   ...
   <div className='w-[5.0%] felx justify-center items-center'>
   <img src={myntra} alt="Myntra Logo" />
   </div>
   <div className='w-[50%] bg-green-500I flex flex-row items-center'>
    <div className ='px-[13px] cursor-pointer'>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
    ...
    <input className='h-[50%] w-[100%] bg-[#F5F5F6] rounded pl-[40px] focus: bg-[white] focus: outline-none focus: border-[2px]' type = "text" placeholder='Search for brands,products and many more'/>
   </div>
